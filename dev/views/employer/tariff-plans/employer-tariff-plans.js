define(['ko', 'da/employers/tariff-plans', 'vm/base'],
function (ko, da, baseVm) {
  function EmployerTariffPlans (params) {
  ...
  baseVm.addPrototypes(EmployerTariffPlans.prototype)

  return EmployerTariffPlans
})
